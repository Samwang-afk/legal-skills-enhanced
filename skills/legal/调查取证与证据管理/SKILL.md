---
name: 调查取证与证据管理
description: 基于请求权要件分析进行证据缺口评估，系统化指引证据收集、调查取证、证人管理和财产保全全流程，生成取证方案、各类申请文书和调查笔录。当用户发送客户编号并提及"调查取证"、"证据收集"、"财产保全"、"调查令"、"证人出庭"、"补充材料"、"取证方案"等指令时触发使用。
version: 1.0.0
category: 民事诉讼
tags: [调查取证, 证据收集, 财产保全, 调查令, 证人, 调查笔录]
author: 【律师姓名】律师
created: 2026-03-29
triggers:
  - 调查取证
...
本 Skill 只处理「调查取证与证据管理」专业任务；案件隔离、事项路径、文件读取、OCR 复查、来源披露、缺口归档、法规/案例/Wiki 核验和复盘台账更新均按法律工作总控共享协议执行。
...
- 用户明确提到「调查取证与证据管理」或本 Skill frontmatter 描述中的任务。
- 用户请求生成、审查、分析、计算、管理或推进与「调查取证与证据管理」对应的法律工作成果。

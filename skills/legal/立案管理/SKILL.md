---
name: 立案管理
description: 系统化指引民事一审立案全流程，包括立案材料核查、管辖权预检、立案方式选择、诉讼费计算、举证期限管理等。当用户发送客户编号并提及"立案"、"去立案"、"立案准备"、"立案材料"、"网上立案"等指令时触发使用。
version: 1.0.0
category: 民事诉讼
tags: [立案, 立案材料, 管辖权, 诉讼费, 举证期限, 网上立案]
author: 【律师姓名】律师
created: 2026-03-29
triggers:
  - 立案
...
本 Skill 只处理「立案管理」专业任务；案件隔离、事项路径、文件读取、OCR 复查、来源披露、缺口归档、法规/案例/Wiki 核验和复盘台账更新均按法律工作总控共享协议执行。
...
- 用户明确提到「立案管理」或本 Skill frontmatter 描述中的任务。
- 用户请求生成、审查、分析、计算、管理或推进与「立案管理」对应的法律工作成果。

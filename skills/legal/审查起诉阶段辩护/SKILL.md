...
name: 审查起诉阶段辩护
description: |
  覆盖审查起诉阶段辩护律师全部工作职责的专业技能模块，包括阅卷权、会见权、调查取证权、
  证据核实权、意见表达权、非法证据排除申请权、控告申诉权等七类核心权利的行使指导，
  以及法律文书生成、量刑预判、与检察机关沟通策略等全流程工作规范。
version: 1.0.0
triggers:
  - 审查起诉
  - 起诉审查
...
本 Skill 只处理「审查起诉阶段辩护」专业任务；案件隔离、事项路径、文件读取、OCR 复查、来源披露、缺口归档、法规/案例/Wiki 核验和复盘台账更新均按法律工作总控共享协议执行。
...
- 用户明确提到「审查起诉阶段辩护」或本 Skill frontmatter 描述中的任务。
- 用户请求生成、审查、分析、计算、管理或推进与「审查起诉阶段辩护」对应的法律工作成果。

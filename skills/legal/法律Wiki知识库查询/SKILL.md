...
name: 法律Wiki知识库查询
description: |
  按罪名/领域/关键词检索 Wiki 知识页，返回知识卡片或全文内容。
  支持刑事罪名知识、民事领域知识、案例知识页的查询与交叉引用跳转。
  当用户提及"查Wiki"、"知识库查询"、"查罪名"、"查法律知识"、"wiki查询"等关键词时触发。
version: 1.1.0
triggers:
  - 查Wiki
  - 知识库查询
...
本 Skill 只处理「法律Wiki知识库查询」专业任务；案件隔离、事项路径、文件读取、OCR 复查、来源披露、缺口归档、法规/案例/Wiki 核验和复盘台账更新均按法律工作总控共享协议执行。
...
- 用户明确提到「法律Wiki知识库查询」或本 Skill frontmatter 描述中的任务。
- 用户请求生成、审查、分析、计算、管理或推进与「法律Wiki知识库查询」对应的法律工作成果。

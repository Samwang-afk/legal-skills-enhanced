---
name: 一审阶段辩护
description: 刑事辩护一审阶段工作Skill，覆盖法院审判阶段的委托衔接、补充阅卷、会见、庭前会议、调查取证、非法证据排除、法庭发问质证举证辩论、认罪认罚、庭后工作与上诉评估。当用户提及"一审阶段"、"刑事一审"、"开庭辩护"、"庭前会议"、"非法证据排除"、"刑事庭审"等关键词时触发使用。
---
...
本 Skill 只处理「一审阶段辩护」专业任务；案件隔离、事项路径、文件读取、OCR 复查、来源披露、缺口归档、法规/案例/Wiki 核验和复盘台账更新均按法律工作总控共享协议执行。
...
- 用户明确提到「一审阶段辩护」或本 Skill frontmatter 描述中的任务。
- 用户请求生成、审查、分析、计算、管理或推进与「一审阶段辩护」对应的法律工作成果。

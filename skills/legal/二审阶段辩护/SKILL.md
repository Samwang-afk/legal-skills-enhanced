---
name: 二审阶段辩护
description: 刑事辩护二审阶段工作Skill，覆盖上诉审委托接案、一审材料衔接、阅卷审查、会见策略、争取开庭、书面辩护意见、二审庭审、不开庭审理沟通、裁判分析及发回重审衔接。当用户提及"二审"、"上诉"、"抗诉"、"争取开庭"、"发回重审"、"二审辩护"等关键词时触发使用。
---
...
本 Skill 只处理「二审阶段辩护」专业任务；案件隔离、事项路径、文件读取、OCR 复查、来源披露、缺口归档、法规/案例/Wiki 核验和复盘台账更新均按法律工作总控共享协议执行。
...
- 用户明确提到「二审阶段辩护」或本 Skill frontmatter 描述中的任务。
- 用户请求生成、审查、分析、计算、管理或推进与「二审阶段辩护」对应的法律工作成果。

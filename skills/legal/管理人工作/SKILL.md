---
name: 管理人工作
description: R1（管理人）专属Skill，覆盖管理人受理后的全部初期工作职责，包括印章与账户管理、财产接管、内部事务管理、合同处理、聘用工作人员、管理人团队管理及报酬方案制定。当用户发送客户编号并提及"管理人接管"、"开始接管"、"接管工作"等指令时触发使用。
version: 1.0.0
category: 破产程序
...
本 Skill 只处理「管理人工作」专业任务；案件隔离、事项路径、文件读取、OCR 复查、来源披露、缺口归档、法规/案例/Wiki 核验和复盘台账更新均按法律工作总控共享协议执行。
...
- 用户明确提到「管理人工作」或本 Skill frontmatter 描述中的任务。
- 用户请求生成、审查、分析、计算、管理或推进与「管理人工作」对应的法律工作成果。

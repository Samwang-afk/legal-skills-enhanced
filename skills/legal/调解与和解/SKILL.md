---
name: 调解与和解
description: 提供调解与和解全流程支持，包括可行性分析、调解方案起草、调解书/和解协议审查、撤诉管理等功能。当用户发送客户编号并提及"调解"、"和解"、"撤诉"、"调解方案"、"调解书"等指令时触发使用。
version: 1.0.0
category: 民事诉讼
tags: [调解, 和解, 撤诉, 调解方案, 调解书, 庭前调解, 诉前调解]
author: 【律师姓名】律师
created: 2026-03-29
triggers:
  - 调解
...
本 Skill 只处理「调解与和解」专业任务；案件隔离、事项路径、文件读取、OCR 复查、来源披露、缺口归档、法规/案例/Wiki 核验和复盘台账更新均按法律工作总控共享协议执行。
...
- 用户明确提到「调解与和解」或本 Skill frontmatter 描述中的任务。
- 用户请求生成、审查、分析、计算、管理或推进与「调解与和解」对应的法律工作成果。

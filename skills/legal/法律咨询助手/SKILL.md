...
**开场声明（强制）：调用本 Skill 时，必须先原样完整输出以下声明块，再继续执行任何任务；但 Quick Reply 客户回复中不得包含本声明。**
> **声明**
>
...
- 简单法律知识问答属于推理等级 L0：不建立 Matter Model、不运行 Advocate/Challenger/Judgment，不做批量澄清；如咨询逐渐暴露案件事实复杂度，由总控升级 L1/L2 后转对应专业 Skill，本 Skill 不自行展开推理链。

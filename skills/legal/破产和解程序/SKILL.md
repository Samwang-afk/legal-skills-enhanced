---
name: 破产和解程序
description: 提供破产和解程序全流程支持，覆盖从和解申请、协议草案编制、债权人会议表决、协议效力确认到执行监督及转清算的完整流程。适用《企业破产法》第95-99条。当用户发送客户编号并提及"破产和解"、"和解协议"、"和解程序"等指令时触发使用。
version: 1.0.0
category: 破产程序
tags: [破产和解, 和解协议, 和解申请, 债权人会议, 破产程序, 企业破产法]
author: 【律师姓名】律师
created: 2026-04-01
triggers:
  - 破产和解
...
本 Skill 只处理「破产和解程序」专业任务；案件隔离、事项路径、文件读取、OCR 复查、来源披露、缺口归档、法规/案例/Wiki 核验和复盘台账更新均按法律工作总控共享协议执行。
...
- 用户明确提到「破产和解程序」或本 Skill frontmatter 描述中的任务。
- 用户请求生成、审查、分析、计算、管理或推进与「破产和解程序」对应的法律工作成果。

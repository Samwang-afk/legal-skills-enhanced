---
name: 简易速裁程序
description: 刑事辩护简易程序、速裁程序及普通程序简化审理分支Skill，重点处理认罪认罚案件中的程序适用审查、量刑协商、庭审简化、权利保障和时间节点管理。作为一审阶段辩护的分支，当用户提及"简易程序"、"速裁程序"、"认罪认罚"、"快速审理"、"当庭宣判"等关键词时触发使用。
---
...
本 Skill 只处理「简易速裁程序」专业任务；案件隔离、事项路径、文件读取、OCR 复查、来源披露、缺口归档、法规/案例/Wiki 核验和复盘台账更新均按法律工作总控共享协议执行。
...
- 用户明确提到「简易速裁程序」或本 Skill frontmatter 描述中的任务。
- 用户请求生成、审查、分析、计算、管理或推进与「简易速裁程序」对应的法律工作成果。

---
name: 结案归档
description: 在判决/调解完成后，系统化完成案卷归档、案件总结、客户移交、费用结算等结案工作。当用户发送客户编号并提及"归档"、"结案"、"案件总结"、"办案小结"、"案卷移交"、"费用结算"等指令时触发使用。
version: 1.0.0
category: 民事诉讼
...
本 Skill 只处理「结案归档」专业任务；案件隔离、事项路径、文件读取、OCR 复查、来源披露、缺口归档、法规/案例/Wiki 核验和复盘台账更新均按法律工作总控共享协议执行。
...
- 用户明确提到「结案归档」或本 Skill frontmatter 描述中的任务。
- 用户请求生成、审查、分析、计算、管理或推进与「结案归档」对应的法律工作成果。

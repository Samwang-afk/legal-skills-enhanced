---
name: 劳动争议仲裁程序管理
description: 劳动争议仲裁程序全流程管理Skill，覆盖仲裁前置强制检测、仲裁时效计算、一裁终局自动判断、仲裁申请书/答辩书生成（W/E双角色）、仲裁请求清单、仲裁→诉讼衔接路由（L9五分支）、仲裁策略报告和用人单位仲裁前风险敞口评估。当用户发送客户编号并提及"仲裁申请"、"仲裁答辩"、"仲裁策略"、"仲裁时效"、"公司仲裁风险"、"风险敞口"等指令时触发使用。
---
...
本 Skill 只处理「劳动争议仲裁程序管理」专业任务；案件隔离、事项路径、文件读取、OCR 复查、来源披露、缺口归档、法规/案例/Wiki 核验和复盘台账更新均按法律工作总控共享协议执行。
...
- 用户明确提到「劳动争议仲裁程序管理」或本 Skill frontmatter 描述中的任务。
- 用户请求生成、审查、分析、计算、管理或推进与「劳动争议仲裁程序管理」对应的法律工作成果。

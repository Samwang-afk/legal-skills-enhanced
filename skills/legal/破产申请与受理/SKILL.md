---
name: 破产申请与受理
description: 覆盖破产申请全流程，包括申请书起草、附件准备、提交跟踪、受理后初步工作。当用户发送客户编号并提及"破产申请"、"重整申请"、"和解申请"等指令时触发使用。
version: 1.0.0
category: 破产程序
tags: [破产申请, 重整申请, 和解申请, 破产清算, 破产受理, 管理人]
author: 【律师姓名】律师
created: 2026-04-01
triggers:
  - 破产申请
...
本 Skill 只处理「破产申请与受理」专业任务；案件隔离、事项路径、文件读取、OCR 复查、来源披露、缺口归档、法规/案例/Wiki 核验和复盘台账更新均按法律工作总控共享协议执行。
...
- 用户明确提到「破产申请与受理」或本 Skill frontmatter 描述中的任务。
- 用户请求生成、审查、分析、计算、管理或推进与「破产申请与受理」对应的法律工作成果。

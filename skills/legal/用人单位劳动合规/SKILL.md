---
name: 用人单位劳动合规
description: 公司端劳动用工合规 Skill。用于用人单位日常劳动合规、员工手册/规章制度/劳动合同更新、工资工时问答、内部劳动政策起草，以及公司在解除、调岗、降薪、处罚、员工投诉或仲裁前的风险预判。用户提到公司劳动合规、员工手册、规章制度、薪酬制度、考勤制度、加班费、发薪日、特殊工时、劳动合同修改、内部政策起草、辞退员工风险、员工投诉公司、调岗降薪等场景时触发。
---
...
本 Skill 只处理「用人单位劳动合规」专业任务；案件隔离、事项路径、文件读取、OCR 复查、来源披露、缺口归档、法规/案例/Wiki 核验和复盘台账更新均按法律工作总控共享协议执行。
...
- 用户明确提到「用人单位劳动合规」或本 Skill frontmatter 描述中的任务。
- 用户请求生成、审查、分析、计算、管理或推进与「用人单位劳动合规」对应的法律工作成果。

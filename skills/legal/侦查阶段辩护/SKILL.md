---
name: 侦查阶段辩护
description: 刑事辩护侦查阶段工作Skill，涵盖会见全流程、案件法律分析与量刑预判、批捕时间节点管理、法律文书生成、执业风险防范等完整辩护工作规范
version: 1.0.0
triggers:
  - 侦查阶段
  - 会见
...
本 Skill 只处理「侦查阶段辩护」专业任务；案件隔离、事项路径、文件读取、OCR 复查、来源披露、缺口归档、法规/案例/Wiki 核验和复盘台账更新均按法律工作总控共享协议执行。
...
- 用户明确提到「侦查阶段辩护」或本 Skill frontmatter 描述中的任务。
- 用户请求生成、审查、分析、计算、管理或推进与「侦查阶段辩护」对应的法律工作成果。
